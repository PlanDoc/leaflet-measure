            ...
            switch (i.type) {
              ...
              case 'GeometryCollection':
                for (o = 0; o < i.geometries.length; o++)
                  if (!1 === t(i.geometries[o], f, l, c, p)) return !1;
                break;
              default:
                throw new Error('Unknown Geometry Type');
            }
    ...
    function s(e, t) {
      n(e, function(e, r, o, n, i) {
        ...
        for (var u = 0; u < e.coordinates.length; u++) {
          ...
          if (!1 === t(Object(l.b)(p, o), r, u)) return !1;
        }
      });
    }
    function a(e, t) {
      s(e, function(e, r, n) {
        ...
        if (e.geometry) {
          ...
          if ('Point' !== s && 'MultiPoint' !== s) {
            ...
            return (
              !1 !==
                o(e, function(o, s, u, c, p) {
                  if (void 0 === a) return void (a = o);
                  var f = Object(l.e)([a, o], e.properties);
                  if (!1 === t(f, r, n, p, i)) return !1;
                  i++, (a = o);
                }) && void 0
            );
          }
    ...
    function o(e, t, r) {
      ...
      var x,
        ...
        D = M.call(t, 'sourceURL')
          ...
          : '';
      e.replace(A, function(t, r, o, n, i, s) {
        return (
          o || (o = n),
          (S += e.slice(E, s).replace(w, u)),
          r && ((x = !0), (S += "' +\n__e(" + r + ") +\n'")),
          i && ((k = !0), (S += "';\n" + i + ";\n__p += '")),
          o && (S += "' +\n((__t = (" + o + ")) == null ? '' : __t) +\n'"),
          (E = s + t.length),
  ...
  function(e, t, r) {
    ...
    function a(e, t, r) {
      ...
      if (t && t.options && t.options.crs === L.CRS.Simple) {
        if ((t.options.ppm || (t.options.ppm = 1), (o = 0), e))
          for (var n = 0; n < e.length - 1; n++) o += t.options.crs.distance(e[n], e[n + 1]);
        o /= t.options.ppm;
      } else o = 1e3 * (0, p.default)(r.toGeoJSON(), { units: 'kilometers' });
      return o;
    }
    function u(e, t, r) {
      var o = void 0;
      return (
        t && t.options && t.options.crs === L.CRS.Simple
          ? (t.options.ppm || (t.options.ppm = 1), (o = l(e) / (t.options.ppm * t.options.ppm)))
          : (o = (0, h.default)(r.toGeoJSON())),
        o
      );
    }
    function l(e) {
